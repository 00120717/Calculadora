...
import Calculadora.operacionProducer;
...
public class Ventana extends JPanel{
    AbstractFactory Aritmetica,Convertir;
    ...
    public Ventana() {
        Aritmetica=operacionProducer.getOperacion("Arit");
        Convertir=operacionProducer.getOperacion("Conver");
        Aritmetica suma=Aritmetica.getAritmetica("suma");
        Aritmetica resta=Aritmetica.getAritmetica("resta");
        Aritmetica multiplicacion=Aritmetica.getAritmetica("multi");
        Aritmetica division=Aritmetica.getAritmetica("division");
        Conversor binario=Convertir.getConversor("binario");
